...
class GMWDViewShortcode_gmwd extends GMWDView{
    ...
    ?>  
        ...
        <script src="<?php echo GMWD_URL . '/js/util.js'; ?>" type="text/javascript"></script>
        ...
        <script src="<?php echo GMWD_URL . '/js/init_map_admin.js'; ?>" type="text/javascript"></script>
         <?php  if(defined('GMWDMC_NAME') && is_plugin_active(GMWDMC_NAME.'/'.GMWDMC_NAME.'.php')){
         ?>
            <script src="<?php echo GMWDMC_URL . '/js/markerclusterer.js'; ?>" type="text/javascript"></script>
            <script src="<?php echo GMWDMC_URL . '/js/main.js'; ?>" type="text/javascript"></script>
         <?php   
         }  
        ?>
        ...
        <script>
            var centerLat,centerLng,zoom,mapType,maxZoom,minZoom,mapWhellScrolling,mapDragable,mapDbClickZoom, enableZoomControl,enableMapTypeControl,mapTypeControlOptions,enableScaleControl,enableStreetViewControl,enableFullscreenControl,enableRotateControl, mapTypeControlPosition, fullscreenControlPosition,zoomControlPosition,streetViewControlPosition ,mapTypeControlStyle, mapBorderRadius, enableBykeLayer, enableTrafficLayer,enableTransitLayer,geoRSSURL,KMLURL, fusionTableId,fusionTableWhereField,fusionTableWhereOperator, fusionTableWhereValue,        
            mapMarkers,mapCircles,mapRectangles,mapPolygons,mapPolylines,mapTheme,GMWD_URL, enableDirections, markerListingType, markerDefaultIcon;
            ...
            function gmwdInitShortcodeMap(mapId){
                ...
                jQuery.post(ajax_url,  data, function (data){
                    data = JSON.parse(data);
                     ...
                     fusionTableWhereField = data.fusion_table_where_filed; 
                     fusionTableWhereOperator = data.fusion_table_where_operator;   
                     fusionTableWhereValue = data.fusion_table_where_value; 
                    <?php if(defined('GMWDMC_NAME') && is_plugin_active(GMWDMC_NAME.'/'.GMWDMC_NAME.'.php')){
                    ?>
                         markerCLustering = data.enable_marker_clustering ; 
                         markerCLusteringZoom = data.marker_cluster_zoom ;  
                         markerCLusteringSize = data.marker_cluster_size;   
                         markerCLusteringStyle = data.marker_cluster_style; 
                         gmwdmc = {};
                         gmwdmc.GMWDMC_URL = "<?php echo GMWDMC_URL;?>";
