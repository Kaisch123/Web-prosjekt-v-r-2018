...
class GMWDViewRectangles_gmwd extends GMWDView{
	...
	?>
		...
		<div class="pois_wrapper gmwd_edit">
			<form method="post" action="" id="adminForm">
                ...
                <h2 class="overlay_title wd-clear">
                    <div class="wd-left">
                        <img src="<?php echo GMWD_URL . '/images/css/rectangle-active-tab.png';?>" width="30" style="vertical-align:middle;">
                        <span><?php _e("Add Rectangle","gmwd");?></span>
                    </div>
                    <div class="wd-right">
                        <button class="wd-btn wd-btn-secondary" onclick="gmwdAddPoi();return false;"><?php isset($_GET["hiddenName"]) ? _e("Edit Rectangle","gmwd") : _e("Add Rectangle","gmwd") ;?></button>
				...
				<div class="wd-clear">
					<div class="wd-left">
						<table class="pois_table">
							<tr>
								<td><label for="title" title="<?php _e("Add a title for the marked rectangle area.","gmwd");?>"><?php _e("Title","gmwd");?>:</label></td>
								<td><input type="text" name="title" id="title" value="<?php echo $row->title;?>" class="wd-form-field wd-poi-required" ></td>
 								<td><label for="line_width" title="<?php _e("Set line width for marked rectangle area.","gmwd");?>"><?php _e("Line Width","gmwd");?>:</label></td>
							...
							<tr>
								<td><label for="link" title="<?php _e("Link the rectangle area with URL.","gmwd");?>"><?php _e("Link","gmwd");?>:</label></td>
								<td><input type="text" name="link" id="link" value="<?php echo $row->link;?>" class="wd-form-field" ></td>
                                <td><label for="line_color" title="<?php _e("Choose a color of marked rectangle area line.","gmwd");?>"><?php _e("Line Color","gmwd");?>:</label></td>
								<td><input type="text" name="line_color" id="line_color" value="<?php echo $row->line_color;?>" class="color wd-form-field"></td>
							</tr>
							<tr>
								<td><label for="south_west" title="<?php _e("Rectangle south west.","gmwd");?>"><?php _e("South West","gmwd");?>:</label></td>
								<td><input type="text" name="south_west" id="south_west"  class="wd-form-field wd-poi-required" value="<?php echo $row->south_west;?>"></td>
								<td><label for="line_opacity" title="<?php _e("Determine the line color opacity of rectangle.","gmwd");?>"><?php _e("Line Opacity","gmwd");?>:</label></td>
							...
							<tr>
								<td><label for="north_east" title="<?php _e("Rectangle north east.","gmwd");?>"><?php _e("North East","gmwd");?>:</label></td>
								<td><input type="text" name="north_east" id="north_east"  class="wd-form-field wd-poi-required" value="<?php echo $row->north_east;?>"></td>
                                <td><label for="fill_color" title="<?php _e("Determine rectangle body color.","gmwd");?>"><?php _e("Fill Color","gmwd");?>:</label></td>
							...
							<tr>
                                ...
                                <td><label for="fill_opacity" title="<?php _e("Determine rectangle body color opacity.","gmwd");?>" ><?php _e("Fill Opacity","gmwd");?>:</label></td>
							...
							<tr>
								...
								<td>								
									<input type="radio" class="inputbox wd-form-field" id="enable_info_windows0" name="enable_info_windows" <?php echo (($row->enable_info_windows) ? '' : 'checked="checked"'); ?> value="0"  >
									<label for="enable_info_windows0"><?php _e("No","gmwd"); ?></label>
									<input type="radio" class="inputbox wd-form-field" id="enable_info_windows1" name="enable_info_windows" <?php echo (($row->enable_info_windows) ? 'checked="checked"' : ''); ?> value="1"  >
									<label for="enable_info_windows1"><?php _e("Yes","gmwd"); ?></label>						
								</td>                           
								<td><label for="line_color_hover" title="<?php _e("Determine rectangle line color on hover.","gmwd");?>"><?php _e("Line Color Hover","gmwd");?>:</label></td>
							...
							<tr>
                                <td></td>
                                <td></td>                             
								<td><label for="line_opacity_hover" title="<?php _e("Determine rectangle line color opacity on hover.","gmwd");?>"><?php _e("Line Opacity Hover","gmwd");?>:</label></td>
							...
							<tr>
                                <td></td>
                                <td></td>                             
								<td><label for="fill_color_hover" title="<?php _e("Determine rectangle body color on hover.","gmwd");?>"><?php _e("Fill Color Hover","gmwd");?>:</label></td>
							...
							<tr>
                                <td></td>
                                <td></td>                            
								<td><label for="fill_opacity_hover" title="<?php _e("Determine rectangle body color opacity on hover.","gmwd");?>"><?php _e("Fill Opacity Hover","gmwd");?>:</label></td>
							...
							<tr>
								<td><label title="<?php _e("Publish your rectangle.","gmwd");?>"><?php _e("Published:","gmwd"); ?></label></td>
								<td>
							...
							<tr>								
								<td colspan="4">
									<button class="wd-btn wd-btn-primary" onclick="gmwdAddPoi();return false;"><?php isset($_GET["hiddenName"]) ? _e("Edit Rectangle","gmwd") : _e("Add Rectangle","gmwd") ;?></button>				
									<button class="wd-btn wd-btn-secondary" onclick="gmwdClosePoi();return false;"><?php  _e("Cancel","gmwd") ;?></button>
								</td>                                
							</tr>	
						</table>
				...
				<input type="hidden" id="dragged_marker_side_lat">                
				<input type="hidden" id="dragged_marker_side_lng">                
			</form>
		</div>	
		<script>
        ...
        <script src="<?php echo GMWD_URL . '/js/rectangles_gmwd.js'; ?>" type="text/javascript"></script> 
