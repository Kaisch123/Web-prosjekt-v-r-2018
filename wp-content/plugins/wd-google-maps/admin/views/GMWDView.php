...
class GMWDView  {
	...
	public function __construct($model) {
        ...
        if(GMWDHelper::get('ajax') !=1){
            if(GMWDHelper::get('page') == "maps_gmwd" || GMWDHelper::get('page') == "options_gmwd" || GMWDHelper::get('page') == "uninstall_gmwd" || GMWDHelper::get('page') == "themes_gmwd" || GMWDHelper::get('page') == "markercategories_gmwd"){
                upgrade_pro();
            }        	
		?>
			<script>			
		...
		<?php
          ...
          if(!gmwd_get_option("map_api_key")){
               if(GMWDHelper::get('page') == "maps_gmwd" || GMWDHelper::get('page') == "markercategories_gmwd" || GMWDHelper::get('page') == "themes_gmwd" || GMWDHelper::get('page') == "options_gmwd" ){
                    api_key_notice();
               }
           }
		}
