			...
			<div class="gmwd">
				...
				<table class="widefat">
                    ...
                    <tfoot>
                        <tr>
                            <td>
                                <input type="checkbox" name="delete_uploaded_markers" id="delete_uploaded_markers" value="1">
                                <label for="delete_uploaded_markers"><?php _e("Delete the folder containing uploaded markers.","gmwd"); ?></label>
                            </td>
                        </tr>
                    </tfoot>                    
				</table>
