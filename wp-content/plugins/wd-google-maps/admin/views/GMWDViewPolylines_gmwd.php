...
class GMWDViewPolylines_gmwd extends GMWDView{
		...
		<div class="pois_wrapper gmwd_edit">
			<form method="post" action="" id="adminForm">
                ...
                <h2 class="overlay_title wd-clear">
                    <div class="wd-left">
                         <img src="<?php echo GMWD_URL . '/images/css/polyline-active-tab.png';?>" width="30" style="vertical-align:middle;">
                        <span><?php _e("Add Polyline","gmwd");?></span>
                    </div>
                    <div class="wd-right">
                        <button class="wd-btn wd-btn-secondary" onclick="gmwdAddPoi();return false;"><?php isset($_GET["hiddenName"]) ? _e("Edit Polyline","gmwd") : _e("Add Polyline","gmwd") ;?></button>
				...
				<div class="wd-clear">
					<div class="wd-left">
						<table class="pois_table">
							<tr>
								<td><label for="title" title="<?php _e("Add title for polyline.","gmwd");?>"><?php _e("Title","gmwd");?>:</label></td>
								<td><input type="text" name="title" id="title" value="<?php echo $row->title;?>" class="wd-form-field wd-poi-required"></td>
 								<td><label for="line_width" title="<?php _e("Set line width for marked polylines area.","gmwd");?>"><?php _e("Line Width","gmwd");?>:</label></td>
							...
							<tr>
								<td><label for="data" title="<?php _e("This box contains distance information of polylines area.","gmwd");?>"><?php _e("Data","gmwd");?>:</label></td>
								<td><textarea name="data" id="data" class="wd-form-field wd-poi-required"><?php echo $row->data;?></textarea></td>
                                <td><label for="line_color" title="<?php _e("Choose a color of marked polylines area.","gmwd");?>"><?php _e("Line Color","gmwd");?>:</label></td>
							...
							<tr>
								...
								<td><label for="line_opacity" title="<?php _e("Determine the line color opacity of polylines.","gmwd");?>"><?php _e("Line Opacity","gmwd");?>:</label></td>
							...
							<tr>
								...
								<td><label for="line_color_hover" title="<?php _e("Determine polylines line color on hover.","gmwd");?>"><?php _e("Line Color Hover","gmwd");?>:</label></td>
							...
							<tr>
                                <td></td>
                                <td></td>                            
								<td><label for="line_opacity_hover" title="<?php _e("Determine polylines line color opacity on hover.","gmwd");?>"><?php _e("Line Opacity Hover","gmwd");?>:</label></td>
							...
							<tr>
								<td><label title="<?php _e("Publish your polyline.","gmwd");?>"><?php _e("Published:","gmwd"); ?></label></td>
								<td>
							...
							<tr>								
								<td colspan="4">
									<button class="wd-btn wd-btn-primary" onclick="gmwdAddPoi();return false;"><?php isset($_GET["hiddenName"]) ? _e("Edit Polyline","gmwd") : _e("Add Polyline","gmwd") ;?></button>	
									<button class="wd-btn wd-btn-secondary" onclick="gmwdClosePoi();return false;"><?php  _e("Cancel","gmwd") ;?></button>
								</td>                                
							</tr>	
						</table>
				...
				<input type="hidden" id="selected_marker">	
			</form>
		</div>
