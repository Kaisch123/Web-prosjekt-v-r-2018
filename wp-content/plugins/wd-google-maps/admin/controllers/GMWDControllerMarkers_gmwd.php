...
class GMWDControllerMarkers_gmwd extends GMWDController{
    ...
    public function change_marker_size(){
        ...
        if(strpos($file_path,"data:image/png;") !== false){
            ...
            $file_path = GMWD_UPLOAD_URL.'/markers/custom/'.$filename;           
        ...
        $file_path = GMWD_UPLOAD_URL.'/markers'.$base_name[0]."_".$base_name[1].".png";

        $new_file_path_url = GMWD_UPLOAD_URL.'/markers'.$base_name[0]."_".$base_name[1]."_".$size.".png";
        $new_file_path_dir = GMWD_UPLOAD_DIR.'/markers'.$base_name[0]."_".$base_name[1]."_".$size.".png";
